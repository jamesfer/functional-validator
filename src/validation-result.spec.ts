...
import { greaterThan, number, required, string } from './rules';
import { hasProperties } from './groups';

describe('ValidationResult', () => {
  describe('passed()', () => {
    it('should return true if the input was valid', () => {
      const result = validate(7, [greaterThan(5)]);
      expect(result.passed()).toBe(true);
    });

    it('should return true if the input was invalid', () => {
  ...
  describe('throwIfFailed()', () => {
    it('should throw if the input was invalid', () => {
      const result = validate(3, [greaterThan(5)]);
      expect(result.throwIfFailed.bind(result)).toThrowError();
    });

    it('should not throw if the input was valid', () => {
      const result = validate(7, [greaterThan(5)]);
  ...
  describe('flattened()', () => {
    it('should return an array of all validation messages in order', () => {
      const result = validate(3, [greaterThan(5), number(), string()]);
    ...
    it('should return an empty array if there are not validation messages', () => {
      const result = validate(7, [greaterThan(5), number()]);
  ...
  describe('first()', () => {
    ...
    it('should return undefined if there were no errors', () => {
      const result = validate(7, [greaterThan(5), number()]);
